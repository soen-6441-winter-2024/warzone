...
class GameEngineControllerTest {
    ...
    public void setUp() {
        ...
        gameEngineController = new GameEngineController(continentService, countryService, playerService, mapService, ordersService, null, playerCardService, d_repoContinent);
    }
